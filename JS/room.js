...
window.onload = function() {
    ...
    db.collection("SelectedPeopleInRoom").get().then(function(querySnapshot) {
        querySnapshot.forEach(function(doc) {
            ...
            console.log(doc.id, " => ", doc.data(), doc.data().roomname);

            if (doc.data().roomname !== "") {
                document.getElementById("roomNumber").innerText = doc.data().roomname;
            }
        });
    });
